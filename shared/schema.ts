...
export const athletes = pgTable("athletes", {
  ...
  bio: text("bio"),
  rank: integer("rank"),
  olympicRank: integer("olympic_rank"),
  continentalRank: integer("continental_rank"),
  ...
  competitiveHistory: jsonb("competitive_history").$type<{
    career_phases?: Array<{
      phase_name: string;
      period: string;
...
export type AthleteWithSport = Athlete & { sport?: Sport };
