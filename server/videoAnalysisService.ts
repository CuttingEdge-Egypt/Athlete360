...
async function askGeminiWhatToCount(uploadedFile: any, sport: string, roundText: string, language: string = 'english') {
  ...
  const sportScoreInstructions: { [key: string]: string } = {
    ...
    'table tennis': 'Table tennis uses point-by-point scoring (1, 2, 3, etc.) up to 11 or 21 points per game. Track EVERY point scored by watching the scoreboard carefully. Points are awarded after each rally ends. The scoreboard typically shows running point totals for each player (e.g., "5-3", "7-6", "11-9"). Track each point change with timestamp.',
    'table_tennis': 'Table tennis uses point-by-point scoring (1, 2, 3, etc.) up to 11 or 21 points per game. Track EVERY point scored by watching the scoreboard carefully. Points are awarded after each rally ends. The scoreboard typically shows running point totals for each player (e.g., "5-3", "7-6", "11-9"). Track each point change with timestamp.',
    'tabletennis': 'Table tennis uses point-by-point scoring (1, 2, 3, etc.) up to 11 or 21 points per game. Track EVERY point scored by watching the scoreboard carefully. Points are awarded after each rally ends. The scoreboard typically shows running point totals for each player (e.g., "5-3", "7-6", "11-9"). Track each point change with timestamp.',
    'ping pong': 'Table tennis uses point-by-point scoring (1, 2, 3, etc.) up to 11 or 21 points per game. Track EVERY point scored by watching the scoreboard carefully. Points are awarded after each rally ends. The scoreboard typically shows running point totals for each player (e.g., "5-3", "7-6", "11-9"). Track each point change with timestamp.',
