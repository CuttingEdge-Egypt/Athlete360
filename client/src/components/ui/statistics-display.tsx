    ...
    <div className="space-y-6" data-testid="statistics-display">
      ...
      <Tabs defaultValue="recent" className="w-full">
        <TabsList className="grid w-full grid-cols-2 bg-gray-800 border border-slate-200">
          ...
          <TabsTrigger 
            value="alltime" 
            className="text-gray-600 data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-700 data-[state=active]:to-amber-500 data-[state=active]:text-white"
        ...
        <TabsContent value="alltime" className="space-y-6 mt-6">
          <div className="bg-gradient-to-r from-blue-700/10 to-amber-500/10 rounded-lg p-4 border border-blue-500/20">
            <div className="flex items-center space-x-2 mb-4">
