      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <motion.p className="text-lg text-slate-600 dark:text-slate-300 mt-8">
              {displayQuote.split(" ").map((word, index) => (
                <motion.span
                  key={index}
                  initial={{
                    filter: "blur(10px)",
          ...
          <div className={`flex gap-4 pt-12 md:pt-0 ${isRTL ? 'flex-row-reverse' : ''}`}>
            ...
            >
              <IconArrowLeft className="h-5 w-5 text-slate-700 dark:text-white group-hover/button:rotate-12 transition-transform duration-300" />
            </button>
            <button
              onClick={handleNext}
              className="h-7 w-7 rounded-full bg-slate-200 dark:bg-white/10 flex items-center justify-center group/button"
            ...
            >
              <IconArrowRight className="h-5 w-5 text-slate-700 dark:text-white group-hover/button:-rotate-12 transition-transform duration-300" />
            </button>
          </div>
        </div>
      </div>
