    ...
    onError: (error: any) => {
      ...
      toast({
        title: isInsufficientTokens 
          ...
          : t("comparison.comparisonFailed", "Comparison Failed"),
        description: isInsufficientTokens
          ...
          : error.message || t("comparison.comparisonError", "Failed to generate comparison"),
        variant: "destructive",
      });
    },
    onSettled: () => {
                    ...
                    <TabsContent value="overview" className="space-y-4">
                      ...
                      <Card className="bg-gradient-to-r from-indigo-900/30 to-purple-900/30 border-purple-600">
                        <CardContent className="p-6 text-center">
                          ...
                          <div className="text-sm text-gray-400 mb-2">Final Predicted Winner</div>
