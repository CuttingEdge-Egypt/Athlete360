...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 left-0 right-0 z-[100000] flex max-h-screen w-full flex-col-reverse p-4 sm:right-0 sm:left-auto sm:flex-col md:max-w-[420px] pointer-events-auto",
      className
    )}
    data-react-remove-scroll-lock="false"
    data-radix-scroll-guard=""
