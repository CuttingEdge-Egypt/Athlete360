              ...
              <div className="bg-background/50 rounded-lg p-4 space-y-2">
                ...
                {status === "completed" && amount && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold text-green-600">
                      {amount === "15" ? "500" : amount === "25" ? "1000" : amount === "50" ? "2500" : "0"} {t('units.tokens')}
                    </span>
                  </div>
                )}
                {user && status === "completed" && (
                  <div className="flex justify-between text-sm pt-2 border-t">
                    ...
                    <span className="font-bold text-primary">{user.tokens} {t('units.tokens')}</span>
                  </div>
                )}
              </div>
              ...
              {status === "completed" && (
                <div className="bg-primary/5 rounded-lg p-4">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Use your {t('units.tokens')} to analyze athlete performance</li>
