...
export default function Home() {
  ...
  // Check if a valid specific country is selected (not empty)
  const isValidCountrySelected = selectedCountry && selectedCountry.trim() !== '';
  ...
  const handleCreateAthleteWithAI = async (athleteName: string) => {
    ...
    if (!isValidCountrySelected) {
      ...
      toast({
        ...
        description: t('athleteSearch.countryRequired.description'),
        variant: "destructive",
      });
      return;
    }
