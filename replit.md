...
**AI Search Fix & Feature Enhancement (August 6, 2025)**: Fixed broken AI search functionality by reverting to gpt-4o model (o3-pro not available in OpenAI API). Restored working athlete search with AI-powered data enrichment. Enhanced image search to reject incompatible sports images (e.g., basketball images for taekwondo athletes). Added reference links display in biographies for source verification, especially https://www.taekwondodata.com/ for taekwondo athletes. All AI-powered analysis services now use gpt-4o for reliable athlete profiling, detailed analysis, comparison features, and specific analysis generation.
