...
**OpenAI o3 Model & Web Search Integration (August 6, 2025)**: Updated all AI functionality to use the o3 model across the platform with integrated web search capability. Added web search endpoint to enhance athlete data gathering with real-time information before AI analysis. Restored working athlete search with AI-powered data enrichment and enhanced prompts that reject placeholder text like [City, State], [Year], [Championship Name]. Enhanced image search to reject incompatible sports images (e.g., basketball images for taekwondo athletes). Added reference links display in biographies for source verification, especially https://www.taekwondodata.com/ for taekwondo athletes. All AI-powered analysis services now use o3 for reliable athlete profiling, detailed analysis, comparison features, and specific analysis generation.
