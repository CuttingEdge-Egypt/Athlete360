...
**OpenAI Model Upgrade to o3-pro (August 6, 2025)**: Upgraded all OpenAI API calls from o3 to o3-pro model across the entire platform. Updated athlete search prompts to consider selected sport and nationality for improved accuracy. Added current date requirement to all AI prompts to ensure up-to-date player information. All AI-powered analysis services now use o3-pro including athlete profiling, detailed analysis, comparison features, and specific analysis generation. Enhanced image search to reject incompatible sports images (e.g., basketball images for taekwondo athletes). Added reference links display in biographies for source verification, especially https://www.taekwondodata.com/ for taekwondo athletes.
