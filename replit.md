...
**OpenAI Model Optimization (August 6, 2025)**: Implemented specialized AI model usage - o3-deep-search for athlete search functionality and o3 for all analysis services. Enhanced image search to reject incompatible sports images (e.g., basketball images for taekwondo athletes). Added reference links display in biographies for source verification, especially https://www.taekwondodata.com/ for taekwondo athletes. All AI-powered analysis services now use o3 for reliable detailed analysis, comparison features, and specific analysis generation, while search uses o3-deep-search for enhanced athlete discovery.
