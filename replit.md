...
**AI Model Correction & Search Enhancement (August 6, 2025)**: Fixed AI search by using GPT-4o model (o3 models not available in OpenAI API). Restored working athlete search with AI-powered data enrichment and enhanced prompts that reject placeholder text like [City, State], [Year], [Championship Name]. Enhanced image search to reject incompatible sports images (e.g., basketball images for taekwondo athletes). Added reference links display in biographies for source verification, especially https://www.taekwondodata.com/ for taekwondo athletes. All AI-powered analysis services now use GPT-4o for reliable athlete profiling, detailed analysis, comparison features, and specific analysis generation.
