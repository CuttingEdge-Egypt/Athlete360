...
**Enhanced Nationality-Adaptive Nutrition Plans (August 12, 2025)**: Completely redesigned nutrition plan generation to be adaptive to athlete's nationality, gender, age, and weight. System now uses GPT-5 with web search to create authentic meal recommendations based on traditional foods from athlete's country (e.g., ful medames and koshari for Egyptian athletes). Enhanced caloric calculations consider gender-specific nutritional needs, age-related metabolism, and weight-specific portions. Added cultural food timing, preparation methods, and climate-appropriate hydration guidelines. Nutrition plans now respect dietary customs while meeting athletic performance requirements.
